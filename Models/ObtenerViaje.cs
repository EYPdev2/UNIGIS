...
namespace ActualizadorDoctosUnigis.Models
{
    public class ObtenerViaje
    {
        ...
        public class Parada
        {
            ...
            public class_Orden Orden { get; set; }
            public clas_Estado[] Estados { get; set; }
            public object[] Incidencias { get; set; }
        ...
        public class class_Orden
        {
            ...
            public object CampoDinamico { get; set; }
            public int IdOrden_opcional { get; set; }
            public object IdJornada_opcional { get; set; }
